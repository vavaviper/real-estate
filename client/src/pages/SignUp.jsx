...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const res = await fetch('api/auth/sign-up', formData);
  };
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button className='bg-slate-700 text-white p-3 rounded-lg up hover:opacity-95 disabled:opacity-80'>Sign Up</button>
      </form>
